...
export const Card = ({ data }) => {
  return (
    <div className={`bg-[${data.bg}] h-[540px] px-[15px] py-[30px] text-[16px] leading-[24px] flex flex-col justify-around items-center rounded-md`}>
      <p className='text-[22px] font-[500] leading-[22px]'>{data.category}</p>
      <p className='text-[33px] font-[600] leading-[33px] text-center'>{data.title}</p>
      <Image src={data.img} height={1200} width={750} alt='about' className='w-[240px] h-[230px]' />
...
export default function About() {
  return (
    <div className='container h-[100dvh] mx-auto px-[10%] grid grid-cols-3 gap-4'>
      ...
      <div className={`bg-[#FFE979] h-[540px] px-[12px] py-[30px] text-[16px] leading-[24px] flex flex-col justify-around items-center rounded-md`}>
        <p className='text-[22px] font-[500] leading-[22px]'>Prototyping</p>
        <p className='text-[33px] font-[600] leading-[33px] text-center'>Research & Development</p>
        <Image src="/images/prototyping.png" height={1200} width={750} alt='about' className='w-[240px] h-[230px]' />
        <div className='flex flex-wrap justify-center gap-2'>
      ...
      <div className={`bg-[#B7F598] h-[540px] px-[12px] py-[30px] text-[16px] leading-[24px] flex flex-col justify-around items-center rounded-md`}>
        <p className='text-[22px] font-[500] leading-[22px]'>Manufacturing</p>
        <p className='text-[33px] font-[600] leading-[33px] text-center'>Product Manufacturing</p>
        <Image src="/images/manufacturing.png" height={1200} width={750} alt='about' className='w-[240px] h-[230px]' />
        <div className='flex flex-wrap justify-center gap-2'>
      ...
      <div className={`bg-[#7ED5F0] h-[540px] px-[12px] py-[30px] text-[16px] leading-[24px] flex flex-col justify-around items-center rounded-md`}>
        <p className='text-[22px] font-[500] leading-[22px]'>Support</p>
        <p className='text-[33px] font-[600] leading-[33px] text-center'>Product Lifecycle Support</p>
        <Image src="/images/support.png" height={1200} width={750} alt='about' className='w-[240px] h-[230px]' />
        <div className='flex flex-wrap justify-center gap-2'>
