...
export default function Partnership() {
  return (
    <div className='container mx-auto px-[10%] py-[60px] flex flex-col justify-center'>
      <div className='text-center'>
        <p className='font-[600] text-[46px] leading-[46px]'>Become Our Partner</p>
        <p className='text-[17px] leading-[25.5px] mt-[15px]'>At RIOD, we believe that partnerships are the cornerstone of success. We invite you to become our valued business partner and embark on a journey towards excellence and innovation. Together, we will reshape the future and create opportunities for growth and prosperity.</p>
      </div>
      <div className='w-full my-[30px] flex justify-between'>
        <div className='bg-[#FFE979] w-[358px] rounded-sm flex flex-col gap-5 p-[20px] justify-center items-center '>
          ...
          <p className='font-[600] text-[46px] leading-[46px]'>#Best Margin</p>
          <p className='text-[17px] leading-[25.5px] mt-[15px] text-center'>Our commitment to your success starts with Industry-best margins for our business partners.
        ...
        <div className='w-[678px] bg-[#FAFBFC] flex flex-col p-[40px]'>
          <p className='font-[600] text-[32px] leading-[46px]'>Business Associate Program</p>
